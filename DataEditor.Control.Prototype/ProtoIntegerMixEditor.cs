...
namespace DataEditor.Control.Prototype
{
    public partial class ProtoIntegerMixEditor : UserControl
    {
        ...
        {
            DataEditor.Help.InitalizedObjectEditorHelper.SetOption(typeof(ProtoIntegerMixEditor), SavedStrings);
        }
        protected static void LoadSettings()
        {
            ...
            try
            {
                argument = DataEditor.Help.InitalizedObjectEditorHelper.GetOption(typeof(ProtoIntegerMixEditor));
            }
            catch { return; }
