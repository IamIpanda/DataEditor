...
namespace DataEditor.Control.Prototype
{
    ...
    public class ProtoImageBackgroundDisplayer : ProtoImageDisplayer
    {
        ...
        {
            DataEditor.Help.InitalizedObjectEditorHelper.SetOption(typeof(ProtoImageBackgroundDisplayer), DefaultBackColors);
        }
        static public void LoadSettings()
        {
            try
            {
                DefaultBackColors = DataEditor.Help.InitalizedObjectEditorHelper.GetOption
