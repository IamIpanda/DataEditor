...
namespace DataEditor.Control.Prototype
{
    ...
    public class ColorHashCollection : Help.HashCollection<int, Color> 
    {
        public ColorHashCollection(Dictionary<int, Color> Value) : base(Value) { }
        public ColorHashCollection() : base(new Dictionary<int, Color>()) { }
    }
}