...
namespace DataEditor.FuzzyData
{
    ...
    [Serializable]
    public partial class FuzzyBignumAdapter : FuzzyObject,ICloneable
    {
         protected FuzzyBignum value;

        public FuzzyBignumAdapter(FuzzyBignum value)
        {
            this.value = value;
            this.ClassName = FuzzySymbol.GetSymbol("Bignum");
        }

        public FuzzyBignumAdapter(string str)
        {
            this.value = GetBignum(str);
            this.ClassName = FuzzySymbol.GetSymbol("Bignum");
        }
        ...
        public event EventHandler<FuzzyValueChangedEventArgs<FuzzyBignum>> ValueChanged;
        public FuzzyBignum Value
        {
            get { return value; }
            set 
            {
        ...
        {
            base.Clone(source);
            FuzzyBignumAdapter S = source as FuzzyBignumAdapter;
            if (S != null) value = S.value;
        }
        static public FuzzyBignum GetBignum(string str)
        {
            FuzzyBignum e = FuzzyBignum.One;
