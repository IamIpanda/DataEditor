...
Builder.In(Builder.add(:group))
	...
	Builder.Add(:choose, {actual: :animation1_id, text: "使用方的动画", choice: {  0 => "无" , nil => FileChoice.new("animation")} })
	Builder.Add(:choose, {actual: :animation2_id, text: "对象方的动画", choice: {  0 => "无" , nil => FileChoice.new("animation")} })
	Builder.Next()

	Builder.Add(:audio, {actual: :menu_se, text: "菜单画面使用的SE",  type: :SE})
	Builder.Add(:choose, {actual: :choose, text: "公共事件", choice: { 0=>"无" , nil => FileChoice.new("commonevent") } })
	Builder.Next()
